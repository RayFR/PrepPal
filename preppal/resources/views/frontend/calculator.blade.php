...
<head>
  ...
  <title>PrepPal • Calculator</title>
  ...
  <main class="container main-content">
    ...
    <section class="card calorie-planner">
      <div class="calorie-header">
        ...
        <p>
        This tool uses standard equations (Mifflin–St Jeor) to estimate your needs.
          It’s a guide only and not medical advice.
        </p>
        ...
        <div class="calorie-grid">
          ...
          <div>
            ...
            <select id="activity" name="activity" required>
              ...
              <option value="light">Lightly active (1–3x per week)</option>
              <option value="moderate">Moderately active (3–5x per week)</option>
              <option value="very">Very active (6–7x per week)</option>
            </select>
          </div>
    ...
    <section class="card" style="margin-top:2rem;">
      ...
      <p>
        Once you’re happy with your target, head to the PrepPal store to see all our
